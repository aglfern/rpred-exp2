...
annotate_model <- function(fold_events, resultFile, type, fold, horiz)
{
   ...
   names(rmspe_val) <- c("val_rmspe_pset_mean", "val_rmspe_pmset_mean", "val_rmspe_pseq_mean")
   ...
   result <- c(fold=type, horizon=horiz, mape_val, non_fit_arr, non_fit_per_arr, perr_tot_arr, mape_val1, rmspe_val, rmspe_val1)
